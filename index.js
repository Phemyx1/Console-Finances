var finances = [
  ...
  // amount of profit/loss over the entire period
  let total = 0;
  ...
  // greatest increase in profit and loss over the entire period
  let maxIncrease = 0;
  let maxIncreaseDate = '';
  ...
  console.log(`${maxIncreaseDate}, ${maxIncrease} `);
  ...
  console.log(`${greatestDecreaseDate}, ${greatestDecrease}.`);
